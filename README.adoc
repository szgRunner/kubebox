...
// Meta
:description: Terminal and Web console for Kubernetes, the current version of kubebox has delete cadvisor、tab debug,at the sametime i had add module podquery podyaml!
// Settings
:idprefix:
:idseparator: -
:experimental:
